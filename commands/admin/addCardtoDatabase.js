...
async function createOrInsertUser(cardName, cardValue, cardCategories, rarity, update) {
    try {
        ...
        if (update) {
            ...
            console.log(`Card "${cardName}" (ID ${update}) updated in the database.`);
        } else {
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option
                ...
                .setDescription("Enter the card's categories (separated by commas)")
                .setRequired(true)
        )
        .addIntegerOption(option =>
            option
                .setName("cardrarity")
                .setDescription("Enter the card's rarity (0-5, 5 being the most rare)")
                .setRequired(true)
        )
        .addIntegerOption(option =>
            option
    ...
    async execute(interaction) {
        ...
        await createOrInsertUser(cardName, cardValue, cardCategories, cardRarity, updateCardId);
