...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption(option =>
            option
                .setName("cardid")
                .setDescription("Enter the ID of the card associated with this move")
                .setRequired(true)
        )
        ...
        .addStringOption(option =>
            option
                .setName("movetype")
                .setDescription("Enter the type of the move (e.g., physical, magical)")
        )
        .addIntegerOption(option =>
            option
                .setName("basedmg")
    ...
    async execute(interaction) {
        ...
        const moveDescription = interaction.options.getString("movedescription");
